...
let stock = cansLeft < 5 ? "Time to restock" : "we're stocked!"; /* application of ternary operator */
console.log(stock);
...
let messageTemp = currentTemp < 5 ? "Chilled to perfection!" : "Needs a cooler!";
...
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."
let messageHour=(currentHour>=7 && currentHour <= 24) ? "Unleash the beast!" : "Better stick to water"; /* ternary operator checks if hour is between 7am and midnight */
